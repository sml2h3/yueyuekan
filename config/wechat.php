...
return [
     ...
     */
    'app_id'  => env('WECHAT_APPID', 'wx928aa42a271dd88c'),         // AppID
    'secret'  => env('WECHAT_SECRET', '880968e5d88c29b30b06c891875d2bad'),     // AppSecret
    'token'   => env('WECHAT_TOKEN', 'tjyskj2016'),          // Token
    'aes_key' => env('WECHAT_AES_KEY', 'SOlxiuePkK0O7sR8ZYmWZ2e3dO6RueclLe1DUQNcyuC'),                    // EncodingAESKey
